def form_message(sub=None, form_type=None, password=None):
    ...
    form_input = """
        <textarea id="message" name="message" rows="3" class="min-w-[400px] min-h-[300px] block w-full rounded-md border-0 p-4 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6"></textarea>
    """
    if form_type:
